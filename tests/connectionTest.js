...
describe("API connection tests", () => {
	it("should convert celsius to fahrenheit via HTTP endpoint", async () => {
	...
	it("should convert fahrenheit to celsius via HTTP endpoint", async () => {
	...
	it("should return error message for unknown/ 404 route", async () => {
